        ...
        <section class="form">
            <div class="container" style="background-color:white;margin-top:50px;border-radius: 15px">
                <div class="form-content">
                    <div class="form-form">
                        <h2 class="form-title" style="color:#008b8b;text-align:center;padding-top:30px">Edit Paper</h2>
                        <form method="POST" action="{{route('paper.update',$paper->id)}}" enctype="multipart/form-data">
                         ...
                         @method('PUT')
                            <div class="form-group">
                                ...
                                <input id="title" type="text" value="{{$paper->title}}" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ old('title') }}" required autocomplete="title" autofocus>
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <input id="category" type="text" value="{{$paper->category}}" class="form-control @error('category') is-invalid @enderror" name="category" value="{{ old('category') }}" required autocomplete="category" autofocus>
                                @error('category')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
